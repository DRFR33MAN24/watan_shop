...
import com.sabeal.watanshop.packages.PackagesFragment;
import com.sabeal.watanshop.profile.Expired_SoldAds;
import com.sabeal.watanshop.profile.Most_ViewedAds;
import com.sabeal.watanshop.profile.MyAds_Rejected;
...
import com.sabeal.watanshop.SplashScreen;
import com.sabeal.watanshop.helper.LocaleHelper;
import com.sabeal.watanshop.home.helper.Location_popupModel;
import com.sabeal.watanshop.messages.Message;
import com.sabeal.watanshop.profile.FragmentProfile;
import com.sabeal.watanshop.profile.MyAds;
import com.sabeal.watanshop.profile.MyAds_Favourite;
import com.sabeal.watanshop.profile.MyAds_Featured;
import com.sabeal.watanshop.profile.MyAds_Inactive;
import com.sabeal.watanshop.signinorup.MainActivity;
import com.sabeal.watanshop.signinorup.MainViewRegisterFragment;
import com.sabeal.watanshop.userAndSellers.Blocked_UserFragment;
import com.sabeal.watanshop.userAndSellers.SellersListFragment;
import com.sabeal.watanshop.utills.Admob;
import com.sabeal.watanshop.utills.CircleTransform;
import com.sabeal.watanshop.utills.GPSTracker;
import com.sabeal.watanshop.utills.Network.RestService;
import com.sabeal.watanshop.utills.RuntimePermissionHelper;
import com.sabeal.watanshop.utills.SettingsMain;
import com.sabeal.watanshop.utills.UrlController;

import static com.sabeal.watanshop.utills.SettingsMain.getMainColor;
...
//        myRef = database.getReference("UserLogin");1111
        activity = this;
...
//        }
        ...
        mainViewRegisterFragment = new MainViewRegisterFragment();
        ...
        try {
            if (settingsMain.getNotificationTitle().equals("")) {
                if (SplashScreen.jsonObjectAppRating != null) {
                    if (SplashScreen.jsonObjectAppRating.getBoolean("is_show")) {
                        showRatingDialog();
                    } else {
                        Log.d("info HomeActivityRating", "False");
                    }
                }
            }
...
//            }
                ...
                Intent intent;
//                if (SettingsMain.isWhizzChatActive) {
//                    intent = new Intent(HomeActivity.this, WhizzChatList.class);
//                } else {
                    intent = new Intent(HomeActivity.this, Message.class);
//                }
                startActivity(intent);
                overridePendingTransition(R.anim.right_enter, R.anim.left_out);
