...
import com.sabeal.watanshop.Images.Nokri_UploadProgressDialolque;
...
import com.sabeal.watanshop.helper.WorkaroundMapFragment;
import com.sabeal.watanshop.home.adapter.ItemEditImageAdapter;
import com.sabeal.watanshop.home.helper.AdPostImageModel;
import com.sabeal.watanshop.home.helper.CalanderTextModel;
import com.sabeal.watanshop.home.helper.ProgressModel;
...
import com.sabeal.watanshop.utills.CircularProgressBar;
...
//                        .bearing(180) // Rotate the camera
        ...
        if (resultCode == RESULT_OK && requestCode==321){
            ...
            for (int i =0;i<pathsList.length;i++){
                ...
                JavaCompressor.compress(EditAdPost.this, file1, new com.sabeal.watanshop.Callback() {
                    @Override
