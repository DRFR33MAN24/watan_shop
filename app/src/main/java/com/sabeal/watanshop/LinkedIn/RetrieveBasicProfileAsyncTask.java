package com.sabeal.watanshop.LinkedIn;
...
import com.sabeal.watanshop.LinkedIn.helpers.OnBasicProfileListener;
import com.sabeal.watanshop.LinkedIn.helpers.RequestHandler;
...
////        String urlInfo = "https://api.linkedin.com/v1/people/url={public-profile-url}";
//        String publicProfileurl = RequestHandler.sendGet(urlInfo,linkedInUser.getAccessToken());
//        Log.d("profi",publicProfileurl);
