...
import com.sabeal.watanshop.home.helper.CustomLocationFilter;
import com.sabeal.watanshop.modelsList.homeCatListModel;
import com.sabeal.watanshop.utills.RoundedTransformation;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (horizontal){
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_locations_horizontal, parent, false);
